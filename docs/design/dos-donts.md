...
- Don't cite Search+AI or Tabs as existing kit primitives; they are spec targets until added under `frontend/src/components/ui/` with a real caller. DatePicker is shipped; do not paste a third-party calendar into a page.
