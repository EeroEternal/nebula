...
在声明式控制面与可观测基线上，补齐兼容/SLO 治理、Benchmark/推荐/Canary，以及可选多租户配额与成本归因。Serving Cell（CellIngress）已下线。真机 GPU e2e、多引擎重复 benchmark、多租户压测仍暂缓。
...
| P2 | Serving Cell 只读接入（**已下线**，不再作为交付能力） |
...
- 功能模块：[`../manual/module.md`](../manual/module.md)
