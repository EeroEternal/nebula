---
name: git-stash-safe
description: Safely use git stash in nebula without stripping feature dependencies or breaking the build. Use when stashing unrelated changes, cleaning the worktree before check/test, or recovering from a stash that may have removed needed files.
---

# Safe `git stash` in nebula
