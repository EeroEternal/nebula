...
export default defineConfig({
   ...
   */
  locale: {
    // default zh-CN getLocale()获取当前选择的语言
    // default: String(localStorage.getItem('umi_locale')) || 'zh-CN',
    default: 'zh-CN',
    antd: true,
  ...
  // },
  // links: [{ rel: 'stylesheet', href: '//at.alicdn.com/t/c/font_3758222_o4xq61qtte.css' }],
  links: [
    { rel: 'stylesheet', href: '/css/iconfont.css' },
    // design.md 字体：Inter + JetBrains Mono（无网时回退系统字体）
    {
      rel: 'stylesheet',
