...
export async function createUser(body: API.User, options?: Record<string, unknown>) {
...
export async function createUsersWithListInput(body: API.User[], options?: Record<string, unknown>) {
