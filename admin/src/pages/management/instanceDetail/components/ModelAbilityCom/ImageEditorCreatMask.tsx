        ...
        {image ? (
          ...
          <div className="h-full">
            ...
            >
              ...
              <p className="ant-upload-text">{l('models.instances.detail.uploadImageTitle')}</p>
              <p className="ant-upload-hint" style={{ fontSize: 14 }}>
                {l('models.instances.detail.uploadInpaintingDesc')}
              </p>
            </Upload.Dragger>
          </div>
        )}
      </div>
      <div className="w-full h-[200px] flex items-center gap-x-[10px] mt-[10px] overflow-hidden">
        <Upload.Dragger
        ...
        >
          {maskImage ? (
            ...
            <>
              ...
              <p className="ant-upload-text">{l('models.instances.detail.uploadMaskTitle')}</p>
              <p className="ant-upload-hint">{l('models.instances.detail.uploadImageTitle')}</p>
            </>
          )}
        </Upload.Dragger>
        <div
        ...
        >
          <div className="absolute left-0 top-0 border-r border-b border-dashed rounded-br-[8px] py-[2px] px-[4px] bg-card z-[100]">
            {l('models.instances.detail.currentMask')}
          </div>
