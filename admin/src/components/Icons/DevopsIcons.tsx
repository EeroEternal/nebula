...
import type { AntdIconProps } from './types';
...
export const AllJobIcons = (props: AntdIconProps) => {
...
export const BatchIcons = (props: AntdIconProps) => {
  const size = props.size || defaultSvgSize;
  return (
    <>
      <Icon
...
export const SteamIcons = (props: AntdIconProps) => {
  const size = props.size || defaultSvgSize;
  return (
    <>
      <Icon
...
export const RunningIcons = (props: AntdIconProps) => {
  const size = props.size || defaultSvgSize;
  return (
    <>
      <Icon
...
export const CancelIcons = (props: AntdIconProps) => {
  const size = props.size || defaultSvgSize;
  return (
    <>
      <Icon
...
export const ErrorIcons = (props: AntdIconProps) => {
  const size = props.size || defaultSvgSize;
  return (
    <>
      <Icon
...
export const RestartIcons = (props: AntdIconProps) => {
  const size = props.size || defaultSvgSize;
  return (
    <>
      <Icon
...
export const UnknownIcons = (props: AntdIconProps) => {
  const size = props.size || defaultSvgSize;
  return (
    <>
      <Icon
...
export const FinishIcons = (props: AntdIconProps) => {
  const size = props.size || defaultSvgSize;
  return (
    <>
      <Icon
