 ...
 * @returns {ReactNode}
 */
export const searchTreeNode = (originValue: string, searchValue: string): ReactNode => {
...
/**
     ...
     * @returns {*}
     */
var getNaNValue = function (value: number | string) {
  if (isNaN(value)) {
...
export const aAdd = (arg1: number | string, arg2: number | string) => {
  ...
  return (aMul(arg1, m) + aMul(arg2, m)) / m;
};
...
* @returns {string}
*/
export const aSub = (arg1: number | string, arg2: number | string)=>{
  arg1 = getNaNValue(arg1);
  arg2 = getNaNValue(arg2);
  var r1, r2, m;
  try {
...
* @returns {number}
*/
export const aMul = (arg1: number | string, arg2: number | string)=>{
  arg1 = getNaNValue(arg1);
  arg2 = getNaNValue(arg2);
  var m = 0,
      s1 = arg1.toString(),
...
* @returns {number}
*/
export const aDiv = (arg1: number | string, arg2: number | string)=>{
  arg1 = getNaNValue(arg1);
  arg2 = getNaNValue(arg2);
  var t1 = 0,
      t2 = 0,
  ...
  return aMul((r1 / r2), Math.pow(10, t2 - t1));
};
/**
 * 
 * @param val 金额格式化
 * @returns 
 */
export const formatNumShow = (val: number | string) => {
...
/**
     ...
     * @returns {string}
     */
export const fix = (num: number | string, len: number)=>{
