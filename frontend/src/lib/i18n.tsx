...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'cells.title': 'Serving Cell',
    'cells.subtitle': '登记外部推理集群的入口，统一查看健康（不修改对方内部机器）',
    'cells.list': '已注册 Cell',
    'cells.loading': '加载中',
    'cells.empty': '暂无 Serving Cell，请注册外部 Ingress',
    'cells.selectHint': '选择一个 Cell 查看入口健康与 Ingress 指标',
    'cells.model': '模型',
    'cells.topology': '拓扑',
    'cells.health': '健康',
    'cells.register': '注册 Cell',
    'cells.registering': '正在注册...',
    'cells.registered': '注册成功',
    'cells.registerFailed': '注册失败',
    'cells.registerHint': '填写外部服务的 API 地址，系统会自动检测是否可用。取消登记不会关闭对方的真实服务。',
    'cells.deregistering': '正在取消注册...',
    'cells.deregistered': '已取消注册（外部服务未停止）',
    'cells.deregisterFailed': '取消注册失败',
    'cells.ingress': 'Cell Ingress',
    'cells.topologyHidden': '内部拓扑不可见',
    'cells.engine': '引擎',
    'cells.stack': 'Serving 栈',
    'cells.dataSourceNote': '数据来自外部集群入口，不参与本集群自动扩缩容决策',
    'cells.ingressMetrics': 'Ingress 指标',
    'cells.observing': '正在探测...',
    'cells.noObs': '尚无观测数据',
    'cells.observeFailed': '观测失败',
    'cells.pending': '排队/运行',
    'cells.kv': 'KV 占用',
    'cells.prefix': 'Prefix 命中',
    ...
    'governance.timelineEmpty': '暂无部署 / Placement / Cell / SLO 事件',
  },
  en: {
    ...
    'cells.title': 'Serving Cells',
    'cells.subtitle': 'Read-only native Gateway / Ingress — Nebula does not manage workers',
    'cells.list': 'Registered Cells',
    'cells.loading': 'Loading',
    'cells.empty': 'No Serving Cells yet — register an external Ingress',
    'cells.selectHint': 'Select a Cell to view ingress health and metrics',
    'cells.model': 'Model',
    'cells.topology': 'Topology',
    'cells.health': 'Health',
    'cells.register': 'Register Cell',
    'cells.registering': 'Registering...',
    'cells.registered': 'Registered',
    'cells.registerFailed': 'Registration failed',
    'cells.registerHint': 'Probes OpenAI /v1/models on base_url. Deregister only removes the Nebula declaration.',
    'cells.deregistering': 'Deregistering...',
    'cells.deregistered': 'Deregistered (external process not stopped)',
    'cells.deregisterFailed': 'Deregister failed',
    'cells.ingress': 'Cell Ingress',
    'cells.topologyHidden': 'Internal topology not visible',
    'cells.engine': 'Engine',
    'cells.stack': 'Serving stack',
    'cells.dataSourceNote': 'Metrics from Cell Ingress only — not written to /stats/ hot path',
    'cells.ingressMetrics': 'Ingress metrics',
    'cells.observing': 'Probing...',
    'cells.noObs': 'No observation yet',
    'cells.observeFailed': 'Observe failed',
    'cells.pending': 'Pending/running',
    'cells.kv': 'KV usage',
    'cells.prefix': 'Prefix hit',
    ...
    'governance.timelineEmpty': 'No deployment / placement / cell / SLO events',
  },
}
