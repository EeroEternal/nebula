...
const ModelCatalogView = lazy(() =>
  import("@/components/views/model-catalog").then((m) => ({ default: m.ModelCatalogView })),
)
const ModelLibraryView = lazy(() =>
  import("@/components/views/model-library").then((m) => ({ default: m.ModelLibraryView })),
)
